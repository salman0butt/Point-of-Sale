              ...
              <div class="card-body row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="product_name" placeholder="Enter Name" name="product_name" required value="<?php if (isset($p_name)) {
	echo $p_name;
}
?>">
                  </div>
...
while ($row = $select->fetch(PDO::FETCH_ASSOC)) {
	$category = $row['name'];
	?>
                      <option value="<?php echo $category; ?>" <?php if ($p_category == $category) {
		echo 'selected';
	}
	?>><?php echo $category; ?></option>
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" min="1" step="1" class="form-control" id="purchase_price" placeholder="Enter Price" name="purchase_price" required value="<?php if (isset($purchase_price)) {
	echo $purchase_price;
}
?>">
                  </div>
                  <div class="form-group">
                    ...
                    <input type="number" min="1" step="1" class="form-control" id="sale_price" placeholder="Enter Price" name="sale_price" required value="<?php if (isset($sale_price)) {
	echo $sale_price;
}
?>">
                  </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="number" min="1" step="1" class="form-control" id="stock" placeholder="Enter stock" name="stock" required value="<?php if (isset($pstock)) {
	echo $pstock;
}
?>">
                  </div>
                  <div class="form-group">
                   ...
                   <textarea name="description" id="description" cols="30" rows="2" class="form-control" placeholder="Enter Description"><?php if (isset($pdescription)) {
	echo $pdescription;
}
?></textarea>
                  </div>
                  ...
                  <div class="form-group">
                   ...
                   <img id="blah" src="<?php if (isset($pimage)) {
	echo "uploads/" . $pimage;
}
?>" alt="your image" style="max-width: 100px;max-height: 100px;margin-top:10px;" />
                  </div>
                </div>
              </div>
            </form>

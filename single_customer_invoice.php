...
<div class="content-wrapper">
  ...
  <div class="content">
    <div class="container-fluid">
      ...
      $invoice_id = $_GET['invoice_id'];
        $stmt = $pdo->prepare("SELECT * FROM `invoice` WHERE `invoice_id` = :invid");
      ...
      while($row_data=$previous_payment->fetch(PDO::FETCH_OBJ)  ){
       ...
       <div class="row col-md-12">
         <div class="col-md-4" style="font-size: 20px;font-weight: bold;">Customer name: <?php echo $customer_name; ?></div>
         <div class="col-md-2" style="font-size: 20px;font-weight: bold;">Grunter: <?php echo $grunter; ?></div>
         ...
         <div class="col-md-2" style="font-size: 20px;font-weight: bold;">total: <?php echo $total; ?></div>
 ...
 <?php } ?>
  ...
  if (isset($_GET['invoice_id'])) {
      ...
      $invoice_id = $_GET['invoice_id'];
        $stmt = $pdo->prepare("SELECT * FROM `invoice_details` WHERE `invoice_id` = :id");
